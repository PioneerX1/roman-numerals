$(document).ready(function() {
  $("#submit").click(function(event) {
    ...
    var carryOver = inputNumber;
    var arrayOfTens = [];
    var count = 0;

    for(var i=1000; i>=1; i/=10) {
    var quotient = (Math.floor(carryOver/i))*i; //Math.floor used to round down
      if (quotient >= 1) {
    ...
    var romanString = arrayOfRoman.toString();
    romanString = romanString.replace(/,/g,"");
    //alert(romanString);
